...
export const menusConfig = {
  mainNav: [
    { title: "Advanced Ui", icon: Book, href: "/chat" },
    {
      title: "Dashboard1",
      icon: DashBoard,
      child: [
  ...
  sidebarNav: {
    modern: [
      { title: "کارتابل", icon: Book, href: "/" },
      { title: "مدیریت", icon: Book, href: "/manager" },
      ...
      },
      {
        ...
        child: [
          {
            title: "مانیتورینگ ناوگان",
            href: "/",
            icon: Graph,
          },
          {
            title: " ثبت تقاضای ناوگان",
            href: "/ecommerce",
            icon: Cart,
          },
          {
            title: " مدیریت اطلاعات سپهتن ",
            href: "/project",
            icon: ClipBoard,
          },
          {
            title: "   نمایش آماری / صویری موقعیت ناوگان ",
            href: "/project",
            icon: ClipBoard,
          },
          {
            title: "   پراکندگی / چگالی ناوگان بر اساس موقعیت ",
            href: "/project",
            icon: ClipBoard,
          },
          {
            title: "مدیریت اطلاعات داپ",
            href: "/project",
            icon: ClipBoard,
          },
        ],
      },
      {
        ...
        child: [
          ...
          {
            title: "وضعت فعال یا غیر فعال بودن سرویس",
            href: "/ecommerce",
            icon: Cart,
          },
          {
            title: "ارسال وضعیت سرویس ",
            href: "/project",
            icon: ClipBoard,
          },
          {
