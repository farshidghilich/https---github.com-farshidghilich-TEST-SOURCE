import { MeyarLogo } from "@/components/svg";
    ...
    <div className="px-4 py-4 ">
      <div className=" flex items-center">
        <Link href="/" className="flex flex-1 items-center gap-x-3  ">
          <Image src={MeyarLogo} alt="site logo" height={50} width={70} />
          {(!collapsed || hovered) && (
            <div className="flex-1  text-sm text-primary  font-semibold">مدیریت عملکرد یکپارچه اهداف راهبردی</div>
          )}
        </Link>
