...
const SingleMenuItem = ({ item, collapsed, trans }: { item: any; collapsed: boolean; trans: any }) => {
                ...
                <Tooltip.Trigger asChild>
                  <span
                    className={cn(
                      ...
                      {
                        "bg-primary text-primary-foreground data-[state=delayed-open]:bg-primary": isLocationMatch(
                          href,
                          locationName
                        ),
