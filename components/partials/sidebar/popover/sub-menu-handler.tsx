      ...
      {collapsed ? (
            ...
            >
              <ScrollArea
                className={cn("p-5", {
                  "h-[250px]":
                    item.child.length > 5 ||
                    item.child.some((childItem: any) => childItem.multi_menu && childItem.multi_menu.length > 5),
                })}
              >
        ...
        >
          <div className="flex-1  gap-3 flex items-start">
            <span className="inline-flex items-center  text-lg ">{/* <item.icon className="w-6 h-6" /> */}</span>
          ...
          <div className="flex-0">
            ...
            >
              <Icon icon="heroicons:chevron-left-20-solid" className="h-5 w-5" />
            </div>
          </div>
        </div>
      )}
