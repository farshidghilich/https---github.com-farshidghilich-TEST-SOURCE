    ...
    <Fragment>
      <div className="min-h-screen bg-background  flex items-center  overflow-hidden w-full">
        <div className="min-h-screen basis-full flex flex-wrap w-full  justify-center overflow-y-auto">
          ...
          <div
            className="basis-1/2 bg-blue-800 w-full  relative hidden xl:flex justify-center items-center bg-gradient-to-br
          ...
          >
            ...
            <div className="relative z-10 backdrop-blur bg-primary-foreground/40 py-14 px-16 2xl:py-[84px] 2xl:pl-[50px] 2xl:pr-[136px] rounded max-w-[640px]">
              <div>
                ...
                >
                  <Icon icon="heroicons:play-solid" className="text-primary-foreground h-[78px] w-[78px] -ml-2" />
                </Button>

                <div className="text-2xl leading-[50px] xl:text-3xl xl:leading-[72px] font-semibold mt-2.5">
                  <span className="text-default-600 dark:text-default-300 ">
                    معیار ، سنجش عملکرد ماست
                    <br />
                  </span>
                </div>
                <div className="mt-2 xl:mt-2 text-default-900 dark:text-default-200  text-xl font-medium">
                  ابزاری برای اندازه گیری معیار سازمان در بخش منابع انسانی
                </div>
              </div>
            </div>
          </div>
      ...
      <Dialog open={openVideo}>
        <DialogContent size="lg" className="p-0" hiddenCloseIcon>
          <Button size="icon" onClick={() => setOpenVideo(false)} className="absolute -top-4 -right-4 bg-default-900">
            <X className="w-6 h-6" />
          </Button>
          <iframe
            width="100%"
